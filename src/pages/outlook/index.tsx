...
//                       <div className="d-flex justify-content-between align-items-start mb-3">
//                         <div>
//                           <h5 className="card-title mb-0">Reconciliation Report</h5>
//                           <p className="text-muted" style={{ fontSize: '13px' }}>
//                             Date Range: {report.dateRange.start} to {report.dateRange.end}
//                           </p>
//                         </div>
...
//                             <div className="card-body">
//                               <div style={{ fontSize: '20px', fontWeight: '700', color: '#2a9d36' }}>{report.summary.matched}</div>
//                               <div style={{ fontSize: '13px', color: '#666' }}>Matched</div>
//                             </div>
//                           </div>
//                         </div>
//                         <div className="col-md-3">
...
//                                 {report.summary.missingFromDb + report.summary.missingFromOutlook}
//                               </div>
//                               <div style={{ fontSize: '13px', color: '#666' }}>Missing</div>
//                             </div>
//                           </div>
//                         </div>
//                         <div className="col-md-3">
...
//                                 {report.summary.strikeDayMismatch + report.summary.frequencyMismatch}
//                               </div>
//                               <div style={{ fontSize: '13px', color: '#666' }}>Mismatches</div>
//                             </div>
//                           </div>
//                         </div>
//                         <div className="col-md-3">
...
//                             <div className="card-body">
//                               <div style={{ fontSize: '20px', fontWeight: '700', color: '#0d6efd' }}>{report.summary.subjectToReview}</div>
//                               <div style={{ fontSize: '13px', color: '#666' }}>Subject to Review</div>
//                             </div>
//                           </div>
//                         </div>
//                       </div>
...
//                           <h6 className="text-warning">
//                             <AlertTriangle size={16} className="me-1" />
//                             Subject to Review (Non-Monthly)
//                           </h6>
//                           <p className="text-muted" style={{ fontSize: '12px' }}>
//                             These policies are in your DB but not in the Outlook document. They have non-monthly frequencies,
//                             so please verify manually.
//                           </p>
//                           <div className="table-responsive">
//                             <table className="table table-sm" style={{ fontSize: '12px' }}>
//                               <thead style={{ backgroundColor: '#f8f9fa' }}>
