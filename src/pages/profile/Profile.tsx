...
// import DatePicker from "react-datepicker";
// import { Link } from "react-router-dom";
// import { avatar01 } from "../../core/data/json/imagepath";
// import Header from "../header";
...
//                   </div>
//                   <div className="col ml-md-n2 profile-user-info">
//                     <h4 className="user-name mb-0">Amani Waziri</h4>
//                     <h6 className="text-muted">amaniwaziri@admin.com</h6>
//                     <div className="user-Location">
//                       <i className="fa fa-map-marker" /> Nairobi, Kenya
//                     </div>
//                     <div className="about-text">
//                       Hello! I'm Amani Waziri, an experienced administrator with a passion for streamlining processes and enhancing user experiences. I thrive in dynamic environments and am dedicated to providing exceptional service.
//                     </div>
//                   </div>
//                   <div className="col-auto profile-btn">
...
//                               Name
//                             </p>
//                             <p className="col-sm-10">Mark Winston</p>
//                           </div>
//                           <div className="row">
//                             <p className="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">
//                               Date of Birth
//                             </p>
//                             <p className="col-sm-10">24 Jul 1999</p>
//                           </div>
//                           <div className="row">
//                             <p className="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">
//                               Email ID
//                             </p>
//                             <p className="col-sm-10">amaniwaziri@example.com</p>
//                           </div>
//                           <div className="row">
//                             <p className="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">
//                               Mobile
//                             </p>
//                             <p className="col-sm-10">0712345678</p>
//                           </div>
//                           <div className="row">
//                             <p className="col-sm-2 text-muted text-sm-end mb-0">
//                               Address
...
//                                         type="email"
//                                         className="form-control"
//                                         defaultValue="amaniwaziri@example.com"
//                                       />
//                                     </div>
//                                   </div>
//                                   <div className="col-12 col-sm-6">
...
//                                         type="text"
//                                         className="form-control"
//                                         defaultValue="#5, 1st Floor, ABC Building"
//                                       />
//                                     </div>
//                                   </div>
//                                   <div className="col-12 col-sm-6">
