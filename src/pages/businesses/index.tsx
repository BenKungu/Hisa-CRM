...
// // Format date to "5th October 2026"
// const formatDateToOrdinal = (dateString: string) => {
//   if (!dateString) return 'N/A';
//   const date = new Date(dateString);
//   if (isNaN(date.getTime())) return 'N/A';
...
//     if (!freq) return '#6c757d';
//     const f = freq.toLowerCase();
//     if (f.includes('month')) return '#0d6efd'; // Blue
//     if (f.includes('annual')) return '#2a9d36'; // Green
//     if (f.includes('quarter')) return '#fd7e14'; // Orange
//     if (f.includes('semi')) return '#6f42c1'; // Purple
//     return '#6c757d';
//   };
...
//     if (response.success) {
//       setUploadStatus('success');
//       // Explicitly map all fields from response.data
//       setUploadResult({
//         newClients: response.data.newClients || 0,
//         updatedClients: response.data.updatedClients || 0,
//         newPolicies: response.data.newPolicies || 0,
...
//       }
//       return (
//         <span className={`badge ${badgeClass} px-2 py-1`} style={{ fontSize: '11px', minWidth: '80px', fontWeight: '500' }}>
//           {icon} {cleanStatus}
//         </span>
//       );
//     },
...
//   // ===== FINANCIAL GROUP (Light Green Background) =====
//   {
//     title: "Initial Premium",
//     dataIndex: "initial_gross_premium",
//     width: 130,
...
//   // ===== SCHEDULE GROUP (Light Blue Background) =====
//   {
//     title: "Strike Day",
//     dataIndex: "strike_date",
//     width: 95,
...
//     width: 150,
//     render: (text: string) => (
//       <span style={{ color: '#2a9d36', fontWeight: '600', fontSize: '14px' }}>
//         <FileText size={14} className="me-1" style={{ color: '#2a9d36' }} />
//         {text || 'N/A'}
//       </span>
//     ),
//     sorter: (a: any, b: any) => (a.policy_number || '').localeCompare(b.policy_number || ''),
...
//     width: 100,
//     render: (value: number) => {
//       if (!value && value !== 0) return <span style={{ color: '#999', fontSize: '13px' }}>not given</span>;
//       const display = getStrikeDayWithOrdinal(value);
...
//     dataIndex: "agent_name",
//     width: 140,
//     render: (text: string) => <span className="text-muted" style={{ fontSize: '13px' }}>{text || 'N/A'}</span>,
//     sorter: (a: any, b: any) => (a.agent_name || '').localeCompare(b.agent_name || ''),
//   },
//   {
//     title: "Last Updated",
